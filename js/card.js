...
const card = async () => {
  ...
  const [localData, remotedata] = await fetchApi('https://raw.githubusercontent.com/ElliotXLeo/bootcamp-frontend-t-g-15/develop/semana-7/4-apimones-card-js/json/pokeapi-api-v2-pokemon-151.json', 'https://pokeapi.co/api/v2/pokemon/151');
  // console.log(localData.sprites.other['official-artwork'].front_default);
  // console.log(localData.id);
  // console.log(localData.name);
  // console.log(localData.types[0].type.name);
  // console.log(localData.stats[0].base_stat);
  // console.log(localData.stats[0].stat.name);
